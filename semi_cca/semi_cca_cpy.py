...
N_color=np.linspace(0, 1.0, X1_set.shape[0])
ax1.scatter(x1_decode[:, 0], x1_decode[:, 1], c=N_color, s=4)
ax2.scatter(X1_set[:, 0], X1_set[:, 1], c=N_color, s=4)
ax3.scatter(x2_decode[:, 0], x2_decode[:, 1], c=N_color, s=4)
ax4.scatter(X2_set[:, 0], X2_set[:, 1], c=N_color, s=4)
